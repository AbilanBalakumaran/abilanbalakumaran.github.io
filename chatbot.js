...
(function () {
  ...
  const KB = [
    ...
    },
    {
      ...
      answer: () => `Un parcours académique pensé pour allier créativité et business 🎓<br><br>🏫 <strong>MBA Digital Marketing & Business</strong> — EFAP Paris (2025–2026)<br>🎨 <strong>Mastère Directeur de Création — Motion Design</strong> — Fonderie de l'Image (2023–2025)<br>&nbsp;&nbsp;→ Mention <strong>Félicitations du jury</strong> 🏅 — Projet : campagne pour <strong>L'Enfant Bleu</strong><br>🖥️ <strong>Bachelor Graphiste Motion Designer</strong> — Icademie (2022–2023)<br>🌐 <strong>DUT Métiers du Multimédia et de l'Internet</strong> — IUT Sénart Fontainebleau (2020–2022)<br><br>De la technique pure jusqu'au management marketing : une formation complète qui lui permet de parler aussi bien à un directeur artistique qu'à un directeur marketing 💡`
    },
    {
